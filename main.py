...
class Window(QDialog):#main window which inherits from QDialog
    ...
    def __init__(self, parent=None):
        ...
        self.plotButton.clicked.connect(self.plot)#perfrom plot function on click
    ...
    def plot(self):#plot function which is performed on clicking on plot button
        ...
        self.error_messages_handling()#function calling
...
if __name__ == '__main__':
    ...
    main = Window() # create a window object
